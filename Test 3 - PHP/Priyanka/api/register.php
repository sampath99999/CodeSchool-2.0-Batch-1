...
if ($_SERVER["REQUEST_METHOD"] == 'POST') {
    ...
    $query = "INSERT INTO users (name, phone, email, password, dob, created_at, updated_at) VALUES (?, ?, ?, ?, ?, current_timestamp, current_timestamp) RETURNING id";

    $statement = $pdo->prepare($query);
    $result = $statement->execute([$name, $phone, $email, $password, $dob]);
