    ...
    success: (response) => {
      ...
      for (let i of data.data) {
        let movie = `
           ...
           <div class="card border-0 p-3 p-lg-0 pb-5 col-lg-3 col-10 m-auto m-lg-0 rounded-3 shadow-lg m-lg-4 mb-5" style="min-height: 350px; max-height: 450px" onclick="details(${i.id})">
              <img src=${i.image_url.slice(1)} class="card-img-top object-fit-cover rounded-3" style="height: 350px" alt="...">
