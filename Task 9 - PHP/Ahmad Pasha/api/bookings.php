...
if ($_SERVER["REQUEST_METHOD"] == 'POST') {
    ...
    $userId = $_GET["user_id"];
    $pdo = getPDO();
    $query ="SELECT seats,start_time,cinema_hall.name as cName,movies.name as mName,cinema_hall.address FROM bookings INNER join show on show.id=bookings.show_id
