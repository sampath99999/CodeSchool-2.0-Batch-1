$(document).ready(function () {
    ...
    if (!token) {
      ...
      $.get("./api/home.php", { token: token }, function (result) {
        ...
        if (!result["user_details"]) {
          ...
          $("#logoutBtn").click(function () {
            ...
            window.location.href = "login.html";
            $.post("./api/logout.php",{userId:result["user_details"]},function(){})
          });
          ...
          var getBookingTablesList = function () {
            ...
            $.get("./api/addBookingTheatersList.php", function (result) {
              var result = JSON.parse(result);
              if (result["status"]) {
