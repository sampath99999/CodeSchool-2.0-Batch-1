...
if ($_SERVER["REQUEST_METHOD"] == 'POST') {
    ...
    $query = "INSERT INTO users (username, password, created_at, updated_at,user_type,token) VALUES (?, ?, now(), now(),?,?)";
    $statment = $pdo->prepare($query);
    $result = $statment->execute([$username, $password, $user_type, $token]);
